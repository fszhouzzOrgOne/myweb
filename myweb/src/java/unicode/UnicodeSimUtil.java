...
public class UnicodeSimUtil {
    ...
    public static List<String> getJapanListString() {
        ...
        // 與下面的有褈複
        String str1 = "";
        str1 += "あいうえおぁぃぅぇぉかきくけこがぎぐげごさしすせそざじずぜぞたちつてとっだぢづでどなにぬねのはひふへほばびぶべぼぱぴぷぺぽまみむめもやゆよゃゅょらりるれろわゐゑをゎんゔゕゖ゙゚゛゜ゝゞゟ゠";
        str1 += "アイウエオァィゥェォカキクケコガギグゲゴサシスセソザジズゼゾタチツテトッダヂヅデドナニヌネノハヒフヘホバビブベボパピプペポマミムメモヤユヨャュョラリルレロワヰヱヲヮンヴヵヶヷヸヹヺ・ーヽヾ";
