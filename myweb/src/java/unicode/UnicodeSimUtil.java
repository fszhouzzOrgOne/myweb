...
public class UnicodeSimUtil {
    private static List<String> biaoqingList = new ArrayList<String>(
            Arrays.asList(":-)", ":-D", ":->", ":-p", ";-)", ":-O", ":-(",
                    ...
                    "(^ ^)", "(^.^)", "(^o^)", "(^q^)", "(^ɜ^)", "(>_<)",
                    "(>c<)", "(>﹏<)", "(>ɛ<)", "(ˉ﹁ˉ)", "(ˉˇˉ)", "(ˉ.ˉ)",
                    "(ˉ~ˉ)", "(ˉoˉ)", "(ˉʒˉ)", "(ˉ_ˉ)", "(ˉ(∞)ˉ)", "(ˉɜˉ)",
                    "(ˉɛˉ)", "(ˉωˉ)", "m(_ _)m", "(-.-)", "(-_-)", "(ｰ̀εｰ́)",
                    "(=ɛ=)", "(= =b)", "(= =#)", "(+﹏+)", "(*_*)", "ʕ*̫͡*ʔ",
                    "(×_×)", "(ˋ﹏ˊ)", "ˋ(• •)ˊ", "('﹏')", "(ˋωˊ)", "(ˋ^ˊ)",
                    "(ˇ_ˇ)", "(•-•)", "(・⊥・)", "(;_;)", "(;o;)", "(˙ɷ˙)",
                    "(˙Ꙫ˙)", "(ఠൠఠ)", "(·ꙫ·)", "^(oo)^", "ก็ʕ•̫͡•ʔก็", "ʕ•̫͡•ʔ",
                    "ʕ•ᴥ•ʔ", "ʕ•ﻌ•ʔ", "ᶘ ᵒᴥᵒᶅ", "ʕ•͓͡•ʔ", "ʕ•֢͠•͠ʔ", "ʕ-̫͡-ʔ",
                    "(˙︿˙)", "(˙ω˙)", "(·ω·)", "(‧  ‧)", "_(:ɜ ˩∠)_", "(: )～",
                    "(:◎)≡", "(๑•ั็ω•็ั๑)", "ฅ•ω•ฅ", "(*ฅ́˘ฅ̀*)", "(•̳ ◡•̳)",
                    "(˘•㉨•˘)", "(´･ω･`)", "(^･ω･^)", "(˙０˙)", "ʕoܫoʔ", "(oܫo)",
                    "(=ﾟ･ﾟ=)", "(°ο°)", "(°○°)", "(°△°)", "(°_°)", "(º_º)",
                    "(o_o)", "(o_O)", "(⊙_⊙)", "(⊙▲⊙)", "(⊙∀⊙)", "(●_⊙)",
                    "(●_●)", "(●0●)", "(●︿●)", "(●ω●)", "(●▽●)", "(●△●)",
                    "(●^●)", "(●-●)", "(Ｑ.Ｑ)", "($_$)", "(@_@)", "(~O~)",
                    "(T-T)", "(T T)", "(T_T)", "(ToT)", "(〒_〒)", "(π_π)",
                    "(◞_◟)", "(◆⊙◆)", "(?﹏?)", "(?o?)", "(∩ω∩)", "(∩_∩)",
                    "(∪︿∪)", "(╯▽╰)", "(￣▽￣)", "(￣ω￣)", "=￣ω￣=", "(－▽－)",
                    "(≧◇≦)", "(≧︿≦)", "(≥▂≤)", "(≥o≤)", "(︶︿︶)", "(︶O︶)",
                    "(╯︿╰)", "(╯ㅁ╰)", "(╰_╯)", "(→_→)", "=^ ^=", "(=^.^=)",
    ...
    public static List<String> getSuperSubScriptListString() {
        ...
        str += " ◌  〪 〫 〬 〭    ྀ  ᷊    ิ    ̄ ͣ ͤ ͥ ͦ ͧ ͨ ͩ ͪ ͫ ͬ ͭ ͮ ͯ ᷓ ᷔ ᷕ ᷖ ᷗ ᷘ ᷙ ᷚ ᷛ ᷜ ᷝ ᷞ ᷟ ᷠ ᷡ ᷢ ᷣ ᷤ ᷥ ᷦ ᷧ ᷨ ᷩ ᷪ ᷫ ᷬ ᷭ ᷮ ᷯ ᷰ ᷱ ᷲ ᷳ ᷴ ⷠ ⷡ ⷢ ⷣ ⷤ ⷥ ⷦ ⷧ ⷨ ⷩ ⷪ ⷫ ⷬ ⷭ ⷮ ⷯ ⷰ ⷱ ⷲ ⷳ ⷴ ⷵ ⷶ ⷷ ⷸ ⷹ ⷺ ⷻ ⷼ ⷽ ⷾ ⷿ ꙴ ꙵ ꙶ ꙷ ꙸ ꙹ ꙺ ꙻ ꚞ ꚟ";
        return mergeFaceString2List(null, str);
    }
