...
public class UnicodeSimUtil {
    ...
    public static List<String> getSuperSubScriptListString() {
        String str = " ⁰ ¹ ² ³ ⁴ ⁵ ⁶ ⁷ ⁸ ⁹ ⁺ ⁻ ⁼ ⁽⁾ ₀ ₁ ₂ ₃ ₄ ₅ ₆ ₇ ₈ ₉ ⏨ ₊ ₋ ₌ ₍₎ ";
        str += " ㆒ ㆓ ㆔ ㆕ ㆖ ㆗ ㆘ ㆙ ㆚ ㆛ ㆜ ㆝ ㆞ ㆟ ";
        str += " ᴬ ᴮ ᴰ ᴱ ᴳ ᴴ ᴵ ᴶ ᴷ ᴸ ᴹ ᴺ ᴼ ᴾ ᴿ ᵀ ᵁ ⱽ ᵂ ᶦ ᶫ ᶰ ᶸ ᵃ ᵇ ᶜ ᵈ ᵉ ᶠ ᵍ ʰ ⁱ ʲ ᵏ ˡ ᵐ ⁿ ᵒ ᵖ ʳ ˢ ᵗ ᵘ ᵛ ʷ ˣ ʸ ᶻ ₐ ₑ ₕ ᵢ ⱼ ₖ ₗ ₘ ₙ ₒ ₚ ᵣ ₛ ₜ ᵤ ᵥ ₓ ";
        str += " ᵝ ᵞ ᵟ ᶿ ᶥ ᵠ ᵡ ᵦ ᵧ ᵨ ᵩ ᵪ 🅪 🅫 ₔ ª º ꝰ ꟸ ꟹ ꭜ ꭝ ꭞ ꭟ ʱ ʴ ʵ ʶ ˀ ˁ ˠ ˤ ᴭ ᴯ ᴲ ᴻ ᴽ ᵄ ᵅ ᵆ ᵊ ᵋ ᵌ ᵑ ᵓ ᵚ ᵸ ᵎ ᵔ ᵕ ᵙ ᵜ ᶛ ᶝ ᶞ ᶟ ᶡ ᶢ ᶣ ᶤ ᶧ ᶨ ᶩ ᶪ ᶬ ᶭ ᶮ ᶯ ᶱ ᶲ ᶳ ᶴ ᶵ ᶶ ᶷ ᶹ ᶺ ᶼ ᶽ ᶾ ꚜ ꚝ ჼ ⵯ ";
        str += " ◌ ͣ ͤ ͥ ͦ ͧ ͨ ͩ ͪ ͫ ͬ ͭ ͮ ͯ ᷓ ᷔ ᷕ ᷖ ᷗ ᷘ ᷙ ᷚ ᷛ ᷜ ᷝ ᷞ ᷟ ᷠ ᷡ ᷢ ᷣ ᷤ ᷥ ᷦ ᷧ ᷨ ᷩ ᷪ ᷫ ᷬ ᷭ ᷮ ᷯ ᷰ ᷱ ᷲ ᷳ ᷴ ᷊ ⷠ ⷡ ⷢ ⷣ ⷤ ⷥ ⷦ ⷧ ⷨ ⷩ ⷪ ⷫ ⷬ ⷭ ⷮ ⷯ ⷰ ⷱ ⷲ ⷳ ⷴ ⷵ ⷶ ⷷ ⷸ ⷹ ⷺ ⷻ ⷼ ⷽ ⷾ ⷿ ꙴ ꙵ ꙶ ꙷ ꙸ ꙹ ꙺ ꙻ ꚞ ꚟ";
        return mergeFaceString2List(null, str);
    }
