...
public class UnicodeSimUtil {
    private static List<String> biaoqingList = new ArrayList<String>(Arrays.asList(":-)", ":-D", ":->", ":-p", ";-)",
            ...
            "●-●", "(ＱＱ)", "($_$)", "(@_@)", "(~O~)", "(T-T)", "(T T)", "(T_T)", "(ToT)", "(〒_〒)", "π_π", "(◞_◟)", "◆⊙◆",
            "(?﹏?)", "(?o?)", "∩ω∩", "∩_∩", "∪︿∪", "╯▽╰", "￣▽￣", "￣ω￣", "－▽－", "≧◇≦", "≧︿≦", "(≥▂≤)", "(≥o≤)", "︶︿︶",
            "︶O︶", "╯︿╰", "╯ㅁ╰", "(╰_╯)", "→_→", "=^ ^=", "(=^.^=)", "ʚΐɞ", "ε==3"));
    ...
    public static List<String> getSpecial1ListString() {
        List<String> list = mergeFaceString2List(null, " ‼ ⁉ ❓ ❔ ❕ ❗ 💯 ‡ † § № ☆ ★ ♡ ○ ● ◎ ◇ ◆ □ ■ △ ▲ ▽ ▼ ⁜ ⁕ ⁎ ⁑ ⁂ ⁚ ⁖ ⁝ ⁘ ⁛ ⁞ ⁙ 〓 ° ◌ ҈ ҉ ̶ ⃢ ⌘ ⌥ ︴ ﹌ ﹉ ﹊ ￣ ¨ ‥ ― ﹍ ﹎ ﹏ ＿ ◟ ◞ ◜ ◝ 〽 〰 ");
        String faces = "🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 🛂 🛃 🛄 🛅 ⚠ 🚸 ⛔ 🚫 🚳 🚭 🚯 🚱 🚷 📵 🔞 ☢ ☣ ";
        faces += " ⏸ ⏹ ⏺ 🎦 🔅 🔆 📶 📳 📴 ♀ ♂ ⚕ ♻ ⚜ 🔱 📛 🔰 ⭕ ✅ ☑ ✔ ✖ ❌ ❎ ➕ ➖ ➗ ➰ ➿ ※ ✳ ✴ ❇ ꧁ ꧂ ▪ ▫ ◻ ◼ ◽ ◾ ⬛ ⬜ 🔶 🔷 🔸 🔹 🔺 🔻 💠 🔘 🔲 🔳 ⚪ ⚫ 🔴 🔵 🏁 🚩 🏴 🏳";
    ...
    public static List<String> getOrderListByString() {
        ...
        sb.append(" ㊀ ㊁ ㊂ ㊃ ㊄ ㊅ ㊆ ㊇ ㊈ ㊉ ㊣ 〇 一 二 三 四 五 六 七 八 九 十 零 壹 贰 貳 叁 叄 肆 伍 陆 陸 柒 捌 玖 拾 佰 仟 万 萬 亿 億 吉 太 拍 艾 ");
