...
public class UnicodeSimUtil {
    private static List<String> biaoqingList = new ArrayList<String>(
            Arrays.asList(":-)", ":-D", "XD", ":->", ":-p", ";-)", ":-O", ":-(",
                    ...
                    "(ˉɜˉ)", "(ˉɛˉ)", "(ˉωˉ)", "m(_ _)m", "(-.-)", "(-_-)",
                    "(ｰ̀εｰ́)", "(=ɛ=)", "(= =b)", "(= =#)", "(+﹏+)", "(*_*)",
                    "ʕ*̫͡*ʔ", "(×_×)", "(ˋ﹏ˊ)", "٩(//̀Д/́/)۶", "ˋ(• •)ˊ",
                    "('﹏')", "(ˋωˊ)", "(ˋ^ˊ)", "(ˇ_ˇ)", "(•-•)", "(・⊥・)",
                    "(;_;)", "(;o;)", "(˙ɷ˙)", "(˙Ꙫ˙)", "(ఠൠఠ)", "(·ꙫ·)",
                    "^(oo)^", "ก็ʕ•̫͡•ʔก็", "ʕ•̫͡•ʔ", "ʕ•ᴥ•ʔ", "ʕ•ﻌ•ʔ",
                    "ᶘ ᵒᴥᵒᶅ", "ʕ•͓͡•ʔ", "ʕ•֢͠•͠ʔ", "ʕ-̫͡-ʔ", "(˙︿˙)", "(˙ω˙)",
                    "(·ω·)", "(‧  ‧)", "_(:ɜ ˩∠)_", "∠(ᐛ ˩∠)_", "(: )～",
                    "(:◎)≡", "(๑•ั็ω•็ั๑)", "ฅ•ω•ฅ", "(*ฅ́˘ฅ̀*)",
                    "(๑•̀ᄇ•́)و ✧ ", "(•̳ ◡•̳)", "(˘•㉨•˘)", "(´･ω･`)", "(^･ω･^)",
                    "(˙０˙)", "∑(❍ฺд❍ฺlll)", "ʕoܫoʔ", "(oܫo)", "(=ﾟ･ﾟ=)",
                    "(°ο°)", "(°○°)", "(°△°)", "(°_°)", "(º_º)", "(⁰_⁰)",
                    "(σﾟ∀ﾟ)σ", "(●°u°●)」", "(ớ ₃ờ)", "(o_o)", "(o_O)", "(⊙_⊙)",
                    "(⊙▲⊙)", "(⊙∀⊙)", "(●_⊙)", "(●_●)", "(●0●)", "(●︿●)",
                    "(●ω●)", "(●▽●)", "(●△●)", "(●^●)", "(●-●)", "(●～●)",
                    "(Ｑ.Ｑ)", "($_$)", "(@_@)", "(~O~)", "(눈_눈)", "(T-T)",
                    "(T T)", "(T_T)", "(ToT)", "(〒_〒)", "(π_π)", "(*꒦ິ⌓꒦ີ)",
                    "(◞_◟)", "(◆⊙◆)", "(?﹏?)", "(?o?)", "(∩ω∩)", "(∩_∩)",
                    "(∪︿∪)", "(╯▽╰)", "(￣▽￣)", "(￣ω￣)", "=￣ω￣=", "(－▽－)",
                    "(≧◇≦)", "(≧︿≦)", "(≥▂≤)", "(≥o≤)", "(︶︿︶)", "(︶O︶)",
                    "(╯︿╰)", "(╯ㅁ╰)", "(╰_╯)", "(→_→)", "=^ ^=", "(=^.^=)",
