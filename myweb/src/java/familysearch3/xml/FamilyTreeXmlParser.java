...
public class FamilyTreeXmlParser {
    ...
    public void parse() throws Exception {
        ...
        DownloadFrame3.addProgress("開始查詢“" + treeItem.getTitle() + "”："
                + treeItem.getIdentifier());
        doParse();

        treeItem.setFinished(true); // 完成狀態
        DownloadFrame3.addProgress("查詢完成“" + treeItem.getTitle() + "”，耗時"
                + (System.currentTimeMillis() - start) + "毫秒：共"
    ...
    private boolean doParse() throws Exception {
        ...
        DownloadFrame3.addProgress("paginatedSearch: " + paginatedSearch);
        if (paginatedSearch) {
            DownloadFrame3.addProgress("繼續查詢“" + treeItem.getTitle() + "”："
                    + treeItem.getIdentifier());
     ...
     * @return void
     */
    private void addNodeToChildren(List<Node> nodeList) throws Exception {
            ...
            if (null != componentOfs && !componentOfs.isEmpty()) {
                ...
                if (componentOf != null
                    ...
                    if (null != identifiers && !identifiers.isEmpty()) {
                        ...
                        if (!info.isImage() && !iden.contains("count")) {
