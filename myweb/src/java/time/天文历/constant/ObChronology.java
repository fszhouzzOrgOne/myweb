...
public class ObChronology {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getEraName(1912));
        System.out.println(getEraName(1644));
        System.out.println(getEraName(917));
        System.out.println(getEraName(627));
        System.out.println(getEraName(618));
        System.out.println(getEraName(220));
    }
    ...
    static {
        ...
        ObChronology.ChronologyTable = new String[lines.length][];
        for (int i = 0; i < lines.length; i++) {
            ObChronology.ChronologyTable[i] = lines[i].split(",");
        }
    }
}
